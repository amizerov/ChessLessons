...
namespace chess5.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public JsonResult SaveProfile(string FirstName, string LastName, string Email, string Phone)
        {
            ...
            return Json(CurrentUser.Account.ChessCoin, JsonRequestBehavior.AllowGet);
        }

        public JsonResult SaveUserImage(string image)
        {
            CurrentUser.Person.Avatar = image;
        ...
        {
            StatGame stGame = new StatGame(CurrentUser.ID);
            StatLesson stLess = new StatLesson(CurrentUser.ID);
            StatPuzzle stPuzz = new StatPuzzle(CurrentUser.ID);
            ViewBag.Game = stGame;
            ViewBag.D = stGame.RatingHistoryStringD;
            ViewBag.R = stGame.RatingHistoryStringR;
            ViewBag.LessonsCnt = stLess.PassedCnt;
            ViewBag.PuzzlesCnt = stPuzz.PassedCnt;

            ViewBag.Account = CurrentUser.Account;

            CPerson p = CurrentUser.Person;
            string f = p.FirstName, l = p.LastName, e = p.Email;
